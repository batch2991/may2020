...
public class Login extends MainClass
{
 ...
 public void signup() throws Exception
 {
	 ...
	 try
	 {
		 ...
		 {
			log=ext.createTest("Login Page_Signup");
			log.log(Status.PASS, "Signup is working");
			
			File f=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			FileUtils.copyFile(f, new File("D:\\may_2020\\images\\signup.png"));
			log.addScreenCaptureFromPath("D:\\may_2020\\images\\signup.png");
		 }
	 }
	 catch(Exception e)
	 {
